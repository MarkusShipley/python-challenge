# python-challenge
Creeated: 12:06 AM EST on 1/9/22
Last Update:12:06 AM EST on 1/9/22

Two folders - one for each chalenge
    1. PyBank
    2. PyPoll
Final updates were push at midnight EST on 1/9/22

If this had been a real world solution, the contents of the readme would contain similar information that captured in the original read me.

I heavily documented commented the Main.py files of both challenges.  However, PyBank is extensively documented because it serves as a learning aid and reference for me going forward.

I wasn't certain as to what needed to be included in this read me because of the detailed homework guidance and well documented scripts.


The instructions and requirments for the homework are below (copied from the course materials)
